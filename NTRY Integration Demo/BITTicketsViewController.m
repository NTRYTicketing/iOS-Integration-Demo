...
#import "BITTicketsViewController.h"
#import "BITTicketCodeViewController.h"
#import "Ticket.h"
#import "Event.h"

@interface BITTicketsViewController () <NSFetchedResultsControllerDelegate>
@property (strong, nonatomic) NSFetchedResultsController *fetchedResultsController;
@end

@implementation BITTicketsViewController
...
{
    if ([[segue identifier] isEqualToString:@"showTicketCode"]) {
        NSIndexPath *indexPath = [self.tableView indexPathForSelectedRow];
        NSManagedObject *object = [[self fetchedResultsController] objectAtIndexPath:indexPath];
        [(BITTicketCodeViewController*)[segue destinationViewController] setTicket:(Ticket*)object];
    }
}
